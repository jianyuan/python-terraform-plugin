...
_STDIODATA = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="data",
            full_name="plugin.StdioData.data",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
StdioData = _reflection.GeneratedProtocolMessageType(
    "StdioData",
    (_message.Message,),
    {
        "DESCRIPTOR": _STDIODATA,
        "__module__": "terraform.protos.grpc_stdio_pb2"
