...
protos-download:
	...
	curl -o terraform/protos/grpc_stdio.proto https://raw.githubusercontent.com/hashicorp/go-plugin/master/internal/plugin/grpc_stdio.proto
...
protos: protos-download
	...
	python -m grpc_tools.protoc -I. --python_out=. --grpclib_python_out=. ./terraform/protos/grpc_stdio.proto
